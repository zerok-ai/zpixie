...
Status SocketTraceConnector::InitBPF() {
  ...
  std::vector<std::string> defines = {
      ...
      absl::StrCat("-DENABLE_CQL_TRACING=", "false"),
      absl::StrCat("-DENABLE_MUX_TRACING=", "false"),
      absl::StrCat("-DENABLE_PGSQL_TRACING=", "false"),
      absl::StrCat("-DENABLE_MYSQL_TRACING=", "false"),
      absl::StrCat("-DENABLE_KAFKA_TRACING=", "false"),
      absl::StrCat("-DENABLE_DNS_TRACING=", "false"),
      absl::StrCat("-DENABLE_REDIS_TRACING=", "false"),
      absl::StrCat("-DENABLE_NATS_TRACING=", "false"),
      absl::StrCat("-DENABLE_AMQP_TRACING=", "false"),
      absl::StrCat("-DENABLE_MONGO_TRACING=", "false"),
  };
...
void SocketTraceConnector::AppendMessage(ConnectorContext* ctx, const ConnTracker& conn_tracker,
  ...
  std::string resp_message_body = resp_message.body;
